...
class Listing:
    def __init__(self, product_name, photo, description, user_id, phone, address, email, categories, state, measurement, hashtags, date, price, id=None):
        if id is None:
            self.id = str(uuid4())
        else:
            self.id = id
